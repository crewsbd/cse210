...
{
    //Boss is like Simple except Boss attacks first and rejecting causes damage.
    private int _health;
    ...
    public override bool Run(Player player, TextImage screen)
    {
        ...
        //Fight loop
        Boolean playerTurn = false;  //Boss goes first
    ...
    {
        int damage = _damageBonuses["Physical"]/2;
        Helpers.Notify($"The {_name} hits you on the way out for {damage} damage.", screen);
        player.InflictDamage(damage); //Even running away, you take some damage.
        return true;
    }
